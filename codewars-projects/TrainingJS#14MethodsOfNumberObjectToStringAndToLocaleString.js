...
function colorOf(r, g, b) {
  let redApple = r.toString(16);
  let greenApple = g.toString(16);
  let blueApple = b.toString(16);

  redApple = redApple.length < 2 ? "0" + redApple : redApple;
  greenApple = greenApple.length < 2 ? "0" + greenApple : greenApple;
  blueApple = blueApple.length < 2 ? "0" + blueApple : blueApple;

  let colors = "#" + redApple + greenApple + blueApple;
  return colors;
}
